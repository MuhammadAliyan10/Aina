...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-sidebar-background text-sidebar-foreground w-[300px] shrink-0",
        className
      )}
      animate={{
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "fixed h-full w-full inset-0 bg-sidebar-background p-10 z-[100] flex flex-col justify-between text-sidebar-foreground",
              className
            )}
          >
            <div
