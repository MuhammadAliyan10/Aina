...
const BrowserEventNode = ({ id, data }: NodeProps) => {
  ...
  const [method, setMethod] = useState(data.method || "Tab Loaded");
    ...
    <div className="relative min-w-[12rem] text-white p-3 rounded-xl shadow-md border border-gray-600 group bg-gray-900 transition-all hover:shadow-lg">
          ...
          <DialogContent className="bg-gray-800 text-white rounded-lg shadow-xl p-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56">
                ...
                >
                  <DropdownMenuRadioItem value="Tab Loaded">
                    Tab Loaded
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="Tab Created">
                    Tab Created
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="Tab Closed">
                    Tab Closed
                  </DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuContent>
      ...
      <div className="flex flex-col items-start gap-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm font-semibold">Browser Events</p>
        </div>
